const fields = [
  { appliesToType: 'person', label: 'contact.age', value: contact.date_of_birth, width: 4, filter: 'patient_age' },
  ...
  { appliesToType: '!person', appliesIf: () => { return /case|trace/.test(contact.contact_type); }, label: 'contact.age', value: contact.date_of_birth, width: 4, filter: 'patient_age' },
