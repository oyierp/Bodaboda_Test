const fields = [
  ...
  { appliesToType: '!person', appliesIf: () => { return /case|trace/.test(contact.contact_type); }, label: 'contact.sex', value: 'contact.sex.' + contact.sex, translate: true, width: 4 },
  { appliesToType: '!person', appliesIf: () => { return /case|trace/.test(contact.contact_type); }, label: 'contact.phone', value: contact && contact.phone, width: 4, filter: 'phone' },
  { appliesToType: '!person', appliesIf: () => { return /case|trace/.test(contact.contact_type); }, label: 'ID Number', value: contact.national_id || contact.passport_number || contact.alien_number || 'N/A', width: 4 },
